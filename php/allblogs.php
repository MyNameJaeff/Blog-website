...
$table = "<div class='allposts d-flex row row-cols-5 justify-content-evenly'>";

if($result->num_rows > 0){
    while($row = $result->fetch_assoc()){
        $table .= "<a href='../blogs/".$row["blogtitle"].".php' color='black' style='border:1px solid black; border-radius:2%; padding:1%; background-color:#fafafa;'><div class='col'>" . "<div style='width:15em; height:15em;'><img src='" .
