<?php include '../php/header.php'; include '../php/blogposter.php';?>
    ...
    <div class='ablogdiv'><p class='titleofablog' name='blogtitlespecific'>This is a showcasae blog 3</p>
...
<img src='../uploads/Terracina.jpg' alt='uploadedimage' width='200px' class='imageofablog'>
</div>
    </main>
